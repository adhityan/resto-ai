#docker build -t docker.registry.home.adhityan.com/stripe-admin -f docker/admin.Dockerfile .
#docker push docker.registry.home.adhityan.com/stripe-admin
...
WORKDIR /app
ENV VITE_BASE_URL=https://payments.earth/api

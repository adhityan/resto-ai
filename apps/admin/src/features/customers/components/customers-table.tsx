...
import { CustomerListItem, useCustomersStore } from "@/stores/customersStore";
...
interface Props {
    ...
    columns: ColumnDef<CustomerListItem>[];
    isFetching: boolean;
    total: number;
}

export default function CustomersTable({ data, columns, total }: Props) {
    const setPagination = useCustomersStore((s) => s.setPagination);
